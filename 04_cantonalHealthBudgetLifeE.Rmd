  ...
  iscatter <- function(dd, x, y, z, group, tooltip, xaxis.lab, yaxis.lab = "", colour = "#336666") {
    gg <- ggplot(data = dd, aes_string(x = x, y = y, group = group)) + 
      ...
      geom_text(aes_string(label = group), 
                family = txt["base.font", lang], colour = "white", size = 2.9) + 
      ...
      swi_theme(base_family = txt["base.font", lang], title_family = txt["title.font", lang]) + 
      theme(
        panel.grid.major.y=element_line(color="#b3b3b3", linetype="dotted", size=0.01),
        axis.line.x=element_line(size=0.5),
        plot.margin = unit(c(0, 0, 0.3, 0.1), "cm")
      )
  }
