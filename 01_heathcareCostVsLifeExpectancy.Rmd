...
for(lang in colnames(txt)) {
  ...
  footer2 <-paste0(strwrap(footer2, width = 180, prefix = "\n"), collapse = "")
  ...
  p <- ggplot(
    ...
    geom_point(aes(colour = col, group = iso2c, frame = .frame), size = 4, shape = 18, alpha = 1) +
    geom_text(
    ...
    sTheme(
      base_size = 25, base_family = txt['base.font', lang], 
